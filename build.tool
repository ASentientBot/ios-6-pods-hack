...
xcrun -sdk iphoneos clang -dynamiclib -fmodules -Wno-unused-getter-return-value -arch armv6 -arch armv7 -arch arm64 -miphoneos-version-min=6 -F . -framework CydiaSubstrate main.m -o "$dylib"
